//Vatsalya: FR epsilon relaxation, monitored-expression, min-epsilon, and true-freeze LLAV controls merged with May LLAV infrastructure.
...
protected: //data
  ...
  CFreal m_relaxUp; //Vatsalya: original epsilon oscillated between iterations causing periodic residual spikes; added asymmetric relaxation: fast up (catch shocks), slow down (prevent chatter)
