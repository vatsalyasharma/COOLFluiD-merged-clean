...
private: // data
  ...
  /// Optional explicit convective boundary correction provider.
  std::string m_convBndCorrectionStr;

  /// Optional explicit diffusive boundary correction provider.
  std::string m_diffBndCorrectionStr;
  
  /// Boolean flag for using blending approach
  bool m_useBlending;

  /// Blending type when UseBlending is enabled
  std::string m_blendingTypeStr;
