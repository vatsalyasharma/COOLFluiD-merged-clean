...
#ifndef COOLFluiD_FluxReconstructionMethod_LLAVDiffJacobFluxReconstructionVS_hh
#define COOLFluiD_FluxReconstructionMethod_LLAVDiffJacobFluxReconstructionVS_hh
...
class LLAVDiffJacobFluxReconstructionVS : public LLAVJacobFluxReconstruction {

public: // functions

  /// Constructor
  explicit LLAVDiffJacobFluxReconstructionVS(const std::string& name);

  /// Destructor
  virtual ~LLAVDiffJacobFluxReconstructionVS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_LLAVDiffJacobFluxReconstructionVS_hh
