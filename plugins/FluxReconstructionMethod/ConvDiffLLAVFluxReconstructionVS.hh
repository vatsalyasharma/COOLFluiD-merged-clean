...
#ifndef COOLFluiD_FluxReconstructionMethod_ConvDiffLLAVFluxReconstructionVS_hh
#define COOLFluiD_FluxReconstructionMethod_ConvDiffLLAVFluxReconstructionVS_hh
...
class ConvDiffLLAVFluxReconstructionVS : public DiffRHSFluxReconstruction {

public: // functions

  /// Constructor
  explicit ConvDiffLLAVFluxReconstructionVS(const std::string& name);

  /// Destructor
  virtual ~ConvDiffLLAVFluxReconstructionVS() {}
...
protected: //data
  ...
  /// string expression for monitored variable (e.g. "pressure", "temperature")
  ...
  /// Temporal relaxation for epsilon increase (0=no smoothing, 1=frozen). Fix 15B port.
  CFreal m_relaxUp;

  /// Temporal relaxation for epsilon decrease (0=no smoothing, 1=frozen). Fix 15B port.
  CFreal m_relaxDown;

  /// True freeze: completely skip epsilon recomputation. Fix 22 port.
  bool m_trueFreezeEpsilon;
...
}; // class ConvDiffLLAVFluxReconstructionVS
...
#endif // COOLFluiD_FluxReconstructionMethod_ConvDiffLLAVFluxReconstructionVS_hh
