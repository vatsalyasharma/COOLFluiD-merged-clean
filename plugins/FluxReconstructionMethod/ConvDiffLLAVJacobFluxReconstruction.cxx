...
void ConvDiffLLAVJacobFluxReconstruction::setup()
{
  ...
  if (m_monitoredExpression != "")
  {
    ...
    {
      CFLog(WARN, "ConvDiffLLAVJacobFluxReconstruction::setup() - Unknown MonitoredExpression: "
            << m_monitoredExpression << ". Falling back to MonitoredVar = " << m_monitoredVar << "\n");
    }

    if (m_monitoredPhysVar != MathTools::MathConsts::CFuintMax())
    {
      CFLog(INFO, "ConvDiffLLAVJacobFluxReconstruction::setup() - MonitoredExpression: "
