...
#include "FluxReconstructionMethod/BCMirrorVelocityVS.hh"
...
Framework::MethodStrategyProvider<
    BCMirrorVelocityVS,FluxReconstructionSolverData,BCStateComputer,FluxReconstructionModule >
  BCMirrovVelocityVSProvider("MirrorVelocityVS");

//////////////////////////////////////////////////////////////////////////////

BCMirrorVelocityVS::BCMirrorVelocityVS(const std::string& name) :
...
BCMirrorVelocityVS::~BCMirrorVelocityVS()
{
  CFAUTOTRACE;
}
...
void BCMirrorVelocityVS::computeGhostStates(const vector< State* >& intStates,
					  vector< State* >& ghostStates,
					  const std::vector< RealVector >& normals,
					  const std::vector< RealVector >& coords)
{
  const CFuint dim = PhysicalModelStack::getActive()->getDim();
  const CFreal area2Tol = MathTools::MathConsts::CFrealEps();
...
void BCMirrorVelocityVS::computeGhostGradients
...
void BCMirrorVelocityVS::unsetup()
{
  CFAUTOTRACE;
