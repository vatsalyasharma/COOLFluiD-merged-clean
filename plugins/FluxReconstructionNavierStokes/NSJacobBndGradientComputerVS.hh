...
#ifndef COOLFluiD_FluxReconstructionMethod_NSJacobBndGradientComputerVS_hh
#define COOLFluiD_FluxReconstructionMethod_NSJacobBndGradientComputerVS_hh
 ...
 */
class NSJacobBndGradientComputerVS : public ConvBndCorrectionsRHSJacobFluxReconstruction {

public: // functions

  /// Constructor
  explicit NSJacobBndGradientComputerVS(const std::string& name);

  /// Destructor
  virtual ~NSJacobBndGradientComputerVS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_NSJacobBndGradientComputerVS_hh
