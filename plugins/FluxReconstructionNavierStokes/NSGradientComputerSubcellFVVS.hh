...
#ifndef COOLFluiD_FluxReconstructionMethod_NSGradientComputerSubcellFVVS_hh
#define COOLFluiD_FluxReconstructionMethod_NSGradientComputerSubcellFVVS_hh
...
/**
 * Daughterclass of ConvRHSSubcellFVVS, needed to calculate the gradients for NS
 * with subcell FV blending (adds setGradientVars transformation).
 */
class NSGradientComputerSubcellFVVS : public ConvRHSSubcellFVVS {

public: // functions

  /// Constructor
  explicit NSGradientComputerSubcellFVVS(const std::string& name);

  /// Destructor
  virtual ~NSGradientComputerSubcellFVVS() {}
...
}; // class NSGradientComputerSubcellFVVS
...
#endif // COOLFluiD_FluxReconstructionMethod_NSGradientComputerSubcellFVVS_hh
