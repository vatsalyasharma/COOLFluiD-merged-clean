...
#include "FluxReconstructionNavierStokes/NSGradientComputerVS.hh"
...
MethodCommandProvider< NSGradientComputerVS,
		       FluxReconstructionSolverData,
		       FluxReconstructionNavierStokesModule >
nsGradientComputerVSProvider("ConvRHSNSVS");

//////////////////////////////////////////////////////////////////////////////

NSGradientComputerVS::NSGradientComputerVS(const std::string& name) :
...
void NSGradientComputerVS::computeGradients()
{
...
void NSGradientComputerVS::computeGradientFaceCorrections()
{
  ...
  else if ((getMethodData().getUpdateVarStr() == "Puvt" || (getMethodData().getUpdateVarStr() == "RhoivtTv" || getMethodData().getUpdateVarStr() == "Rhoivt")) && getMethodData().hasArtificialViscosity())
  {
    // Loop over solution pnts to reset the grad updates
    for (CFuint iSolPnt = 0; iSolPnt < m_nbrSolPnts; ++iSolPnt)
    {
...
void NSGradientComputerVS::setup()
{
  CFAUTOTRACE;
