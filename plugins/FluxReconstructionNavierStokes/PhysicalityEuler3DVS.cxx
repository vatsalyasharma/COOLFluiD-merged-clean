...
#include "FluxReconstructionNavierStokes/PhysicalityEuler3DVS.hh"
...
MethodCommandProvider<PhysicalityEuler3DVS, FluxReconstructionSolverData, FluxReconstructionNavierStokesModule>
    PhysicalityEuler3DVSFRProvider("PhysicalityEuler3DVS");

//////////////////////////////////////////////////////////////////////////////

void PhysicalityEuler3DVS::defineConfigOptions(Config::OptionList& options)
{
...
PhysicalityEuler3DVS::PhysicalityEuler3DVS(const std::string& name) :
...
PhysicalityEuler3DVS::~PhysicalityEuler3DVS()
{
}

//////////////////////////////////////////////////////////////////////////////

void PhysicalityEuler3DVS::configure ( Config::ConfigArgs& args )
{
...
bool PhysicalityEuler3DVS::checkPhysicality()
{
  bool physical = true;
...
void PhysicalityEuler3DVS::enforcePhysicality()
{
  const bool Puvt = getMethodData().getUpdateVarStr() == "Puvt" || getMethodData().getUpdateVarStr() == "Pvt";
  const bool Cons = getMethodData().getUpdateVarStr() == "Cons";
...
void PhysicalityEuler3DVS::setup()
{
  CFAUTOTRACE;
...
if(!RhoivtTv){
  ...
  {
    throw Common::ShouldNotBeHereException (FromHere(),"Update variable set is not Euler3DVarSet in PhysicalityEuler3DVSFluxReconstruction!");
  }
  ...
  {
    throw Common::ShouldNotBeHereException (FromHere(),"Update variable set is not Euler3DVarSetMS in PhysicalityEuler3DVSFluxReconstruction!");
  }
...
void PhysicalityEuler3DVS::unsetup()
{
  CFAUTOTRACE;
