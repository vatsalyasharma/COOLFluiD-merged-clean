...
#ifndef COOLFluiD_FluxReconstructionMethod_NSJacobGradientComputerBlendingVS_hh
#define COOLFluiD_FluxReconstructionMethod_NSJacobGradientComputerBlendingVS_hh
...
/**
 * Daughterclass of ConvRHSJacobFluxReconstructionBlending, needed to calculate
 * the gradients for implicit NS schemes with order blending (adds
 * setGradientVars transformation).
 *
 * Without this class, the blending Jacobian convective command computes
 * grad(rho_i) instead of grad(y_i) for NEQ variable sets, producing wrong
 * species diffusion fluxes.
 *
 * @author Fix G1 — gradient variable transformation for order blending (implicit)
 */
class NSJacobGradientComputerBlendingVS : public ConvRHSJacobFluxReconstructionBlending {

public: // functions

  /// Constructor
  explicit NSJacobGradientComputerBlendingVS(const std::string& name);

  /// Destructor
  virtual ~NSJacobGradientComputerBlendingVS() {}
...
}; // class NSJacobGradientComputerBlendingVS
...
#endif // COOLFluiD_FluxReconstructionMethod_NSJacobGradientComputerBlendingVS_hh
