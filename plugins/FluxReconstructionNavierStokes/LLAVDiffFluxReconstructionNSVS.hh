...
#ifndef COOLFluiD_FluxReconstructionMethod_LLAVDiffFluxReconstructionNSVS_hh
#define COOLFluiD_FluxReconstructionMethod_LLAVDiffFluxReconstructionNSVS_hh
 ...
 */
class LLAVDiffFluxReconstructionNSVS : public LLAVDiffFluxReconstructionVS {

public: // functions

  /// Constructor
  explicit LLAVDiffFluxReconstructionNSVS(const std::string& name);

  /// Destructor
  virtual ~LLAVDiffFluxReconstructionNSVS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_LLAVDiffFluxReconstructionNSVS_hh
