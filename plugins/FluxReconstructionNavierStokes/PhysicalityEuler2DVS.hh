#ifndef COOLFluiD_FluxReconstructionMethod_PhysicalityEuler2DVS_hh
#define COOLFluiD_FluxReconstructionMethod_PhysicalityEuler2DVS_hh
 ...
 *
 */
class PhysicalityEuler2DVS : public BasePhysicality {
public:

  /**
   * Constructor.
   */
  explicit PhysicalityEuler2DVS(const std::string& name);

  /**
   * Destructor.
   */
  virtual ~PhysicalityEuler2DVS();
...
#endif // COOLFluiD_FluxReconstructionMethod_PhysicalityEuler2DVS_hh
