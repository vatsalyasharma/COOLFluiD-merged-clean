...
#ifndef COOLFluiD_FluxReconstructionMethod_ConvDiffLLAVFluxReconstructionNSVS_hh
#define COOLFluiD_FluxReconstructionMethod_ConvDiffLLAVFluxReconstructionNSVS_hh
 ...
 */
class ConvDiffLLAVFluxReconstructionNSVS : public ConvDiffLLAVFluxReconstructionVS {

public: // functions

  /// Constructor
  explicit ConvDiffLLAVFluxReconstructionNSVS(const std::string& name);

  /// Destructor
  virtual ~ConvDiffLLAVFluxReconstructionNSVS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_ConvDiffLLAVFluxReconstructionNSVS_hh
