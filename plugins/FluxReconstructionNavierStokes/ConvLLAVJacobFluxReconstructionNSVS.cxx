...
#include "FluxReconstructionNavierStokes/ConvLLAVJacobFluxReconstructionNSVS.hh"
...
MethodCommandProvider< ConvLLAVJacobFluxReconstructionNSVS,
		       FluxReconstructionSolverData,
		       FluxReconstructionNavierStokesModule >
convLLAVRHSJacobNSVSFluxReconstructionProvider("ConvLLAVRHSJacobNSVS");

//////////////////////////////////////////////////////////////////////////////

ConvLLAVJacobFluxReconstructionNSVS::ConvLLAVJacobFluxReconstructionNSVS(const std::string& name) :
...
void ConvLLAVJacobFluxReconstructionNSVS::configure ( Config::ConfigArgs& args )
{
...
void ConvLLAVJacobFluxReconstructionNSVS::computeInterfaceFlxCorrection()
{
...
void ConvLLAVJacobFluxReconstructionNSVS::computeRiemannFluxJacobianNum(const CFreal resFactor)
{
...
void ConvLLAVJacobFluxReconstructionNSVS::prepareFluxComputation()
{
...
void ConvLLAVJacobFluxReconstructionNSVS::computeGradients()
{
...
void ConvLLAVJacobFluxReconstructionNSVS::computeGradientFaceCorrections()
{
...
void ConvLLAVJacobFluxReconstructionNSVS::computeSmoothness()
{
  CFreal sNum = 0.0;
...
void ConvLLAVJacobFluxReconstructionNSVS::computeSmoothness(const CFuint side)
{
  CFreal sNum = 0.0;
...
void ConvLLAVJacobFluxReconstructionNSVS::computeEpsilon0()
{
...
void ConvLLAVJacobFluxReconstructionNSVS::computeEpsilon0(const CFuint side)
{
  // compute a cell average characteristic flow speed. Note that a straight average is used, not a weighted one, maybe change this
  CFreal wavespeed = 0.0;
...
void ConvLLAVJacobFluxReconstructionNSVS::computeEpsToStateJacobianAna()
{
...
void ConvLLAVJacobFluxReconstructionNSVS::setup()
{
  CFAUTOTRACE;
