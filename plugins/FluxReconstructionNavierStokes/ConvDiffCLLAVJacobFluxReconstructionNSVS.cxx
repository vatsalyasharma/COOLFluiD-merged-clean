...
#include "FluxReconstructionNavierStokes/ConvDiffCLLAVJacobFluxReconstructionNSVS.hh"
...
MethodCommandProvider< ConvDiffCLLAVJacobFluxReconstructionNSVS,
		       FluxReconstructionSolverData,
		       FluxReconstructionNavierStokesModule >
convDiffCLLAVRHSJacobNSVSFluxReconstructionProvider("ConvDiffCLLAVRHSJacobNSVS");

//////////////////////////////////////////////////////////////////////////////

ConvDiffCLLAVJacobFluxReconstructionNSVS::ConvDiffCLLAVJacobFluxReconstructionNSVS(const std::string& name) :
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::configure ( Config::ConfigArgs& args )
{
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeWaveSpeedUpdates(vector< CFreal >& waveSpeedUpd)
{
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeInterfaceFlxCorrection()
{
  for (CFuint iFlx = 0; iFlx < m_nbrFaceFlxPnts; ++iFlx)
  {
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeRiemannFluxJacobianNum(const CFreal resFactor)
{
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeRiemannFluxToGradJacobianNum(const CFreal resFactor)
{
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeGradVarsToStateJacobianNum()
{
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeBndGradTerms(RealMatrix& gradTerm, RealMatrix& ghostGradTerm)
{
  for (CFuint iFlx = 0; iFlx < m_nbrFaceFlxPnts; ++iFlx)
  {
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeCellGradTerm(RealMatrix& gradTerm)
{
  for (CFuint iSol = 0; iSol < m_nbrSolPnts; ++iSol)
  {
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeFaceGradTerms(RealMatrix& gradTermL, RealMatrix& gradTermR)
{
  for (CFuint iFlx = 0; iFlx < m_nbrFaceFlxPnts; ++iFlx)
  {
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::prepareFluxComputation()
{
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeGradients()
{
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeGradientFaceCorrections()
{
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeSmoothness()
{
  CFreal sNum = 0.0;
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeSmoothness(const CFuint side)
{
  CFreal sNum = 0.0;
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeEpsilon0()
{
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeEpsilon0(const CFuint side)
{
  // compute a cell average characteristic flow speed. Note that a straight average is used, not a weighted one, maybe change this
  CFreal wavespeed = 0.0;
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::computeEpsToStateJacobianAna()
{
...
void ConvDiffCLLAVJacobFluxReconstructionNSVS::setup()
{
  CFAUTOTRACE;
