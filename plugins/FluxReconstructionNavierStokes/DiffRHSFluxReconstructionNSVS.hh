...
#ifndef COOLFluiD_FluxReconstructionMethod_DiffRHSFluxReconstructionNSVS_hh
#define COOLFluiD_FluxReconstructionMethod_DiffRHSFluxReconstructionNSVS_hh
 ...
 */
class DiffRHSFluxReconstructionNSVS : public DiffRHSFluxReconstruction {

public: // functions

  /// Constructor
  explicit DiffRHSFluxReconstructionNSVS(const std::string& name);

  /// Destructor
  virtual ~DiffRHSFluxReconstructionNSVS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_DiffRHSFluxReconstructionNSVS_hh
