#ifndef COOLFluiD_FluxReconstructionMethod_PhysicalityEuler3DVS_hh
#define COOLFluiD_FluxReconstructionMethod_PhysicalityEuler3DVS_hh
 ...
 *
 */
class PhysicalityEuler3DVS : public BasePhysicality {
public:

  /**
   * Constructor.
   */
  explicit PhysicalityEuler3DVS(const std::string& name);

  /**
   * Destructor.
   */
  virtual ~PhysicalityEuler3DVS();
...
#endif // COOLFluiD_FluxReconstructionMethod_PhysicalityEuler3DVS_hh
