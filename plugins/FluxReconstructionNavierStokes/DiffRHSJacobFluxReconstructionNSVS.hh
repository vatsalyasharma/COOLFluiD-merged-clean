...
#ifndef COOLFluiD_FluxReconstructionMethod_DiffRHSJacobFluxReconstructionNSVS_hh
#define COOLFluiD_FluxReconstructionMethod_DiffRHSJacobFluxReconstructionNSVS_hh
 ...
 */
class DiffRHSJacobFluxReconstructionNSVS : public DiffRHSJacobFluxReconstruction {

public: // functions

  /// Constructor
  explicit DiffRHSJacobFluxReconstructionNSVS(const std::string& name);

  /// Destructor
  virtual ~DiffRHSJacobFluxReconstructionNSVS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_DiffRHSJacobFluxReconstructionNSVS_hh
