...
#ifndef COOLFluiD_FluxReconstructionMethod_NSBndGradientComputerVS_hh
#define COOLFluiD_FluxReconstructionMethod_NSBndGradientComputerVS_hh
 ...
 */
class NSBndGradientComputerVS : public ConvBndCorrectionsRHSFluxReconstruction {

public: // functions

  /// Constructor
  explicit NSBndGradientComputerVS(const std::string& name);

  /// Destructor
  virtual ~NSBndGradientComputerVS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_NSBndGradientComputerVS_hh
