...
#ifndef COOLFluiD_FluxReconstructionMethod_ConvLLAVJacobFluxReconstructionNSVS_hh
#define COOLFluiD_FluxReconstructionMethod_ConvLLAVJacobFluxReconstructionNSVS_hh
 ...
 */
class ConvLLAVJacobFluxReconstructionNSVS : public ConvLLAVJacobFluxReconstruction {

public: // functions

  /// Constructor
  explicit ConvLLAVJacobFluxReconstructionNSVS(const std::string& name);

  /// Destructor
  virtual ~ConvLLAVJacobFluxReconstructionNSVS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_ConvLLAVJacobFluxReconstructionNSVS_hh
