...
#include "FluxReconstructionNavierStokes/DiffRHSJacobFluxReconstructionNSVS.hh"
...
MethodCommandProvider< DiffRHSJacobFluxReconstructionNSVS,
		       FluxReconstructionSolverData,
		       FluxReconstructionNavierStokesModule >
diffRHSJacobNSVSFluxReconstructionProvider("DiffRHSJacobNSVS");

//////////////////////////////////////////////////////////////////////////////

DiffRHSJacobFluxReconstructionNSVS::DiffRHSJacobFluxReconstructionNSVS(const std::string& name) :
...
void DiffRHSJacobFluxReconstructionNSVS::computeWaveSpeedUpdates(vector< CFreal >& waveSpeedUpd)
{
...
void DiffRHSJacobFluxReconstructionNSVS::computeInterfaceFlxCorrection()
{
...
void DiffRHSJacobFluxReconstructionNSVS::computeBndGradTerms(RealMatrix& gradTerm, RealMatrix& ghostGradTerm)
{
  SafePtr< NavierStokesVarSet > navierStokesVarSet = m_diffusiveVarSet.d_castTo< NavierStokesVarSet >();
...
void DiffRHSJacobFluxReconstructionNSVS::computeCellGradTerm(RealMatrix& gradTerm)
{
  SafePtr< NavierStokesVarSet > navierStokesVarSet = m_diffusiveVarSet.d_castTo< NavierStokesVarSet >();
...
void DiffRHSJacobFluxReconstructionNSVS::computeFaceGradTerms(RealMatrix& gradTermL, RealMatrix& gradTermR)
{
  SafePtr< NavierStokesVarSet > navierStokesVarSet = m_diffusiveVarSet.d_castTo< NavierStokesVarSet >();
...
void DiffRHSJacobFluxReconstructionNSVS::prepareFluxComputation()
{
...
void DiffRHSJacobFluxReconstructionNSVS::setup()
{
  CFAUTOTRACE;
