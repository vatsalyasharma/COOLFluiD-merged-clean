...
#ifndef COOLFluiD_FluxReconstructionMethod_LLAVFluxReconstructionNSVS_hh
#define COOLFluiD_FluxReconstructionMethod_LLAVFluxReconstructionNSVS_hh
 ...
 */
class LLAVFluxReconstructionNSVS : public LLAVFluxReconstruction {

public: // functions

  /// Constructor
  explicit LLAVFluxReconstructionNSVS(const std::string& name);

  /// Destructor
  virtual ~LLAVFluxReconstructionNSVS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_LLAVFluxReconstructionNSVS_hh
