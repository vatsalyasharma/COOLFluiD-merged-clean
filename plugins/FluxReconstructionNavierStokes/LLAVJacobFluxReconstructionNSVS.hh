...
#ifndef COOLFluiD_FluxReconstructionMethod_LLAVJacobFluxReconstructionNSVS_hh
#define COOLFluiD_FluxReconstructionMethod_LLAVJacobFluxReconstructionNSVS_hh
 ...
 */
class LLAVJacobFluxReconstructionNSVS : public LLAVJacobFluxReconstruction {

public: // functions

  /// Constructor
  explicit LLAVJacobFluxReconstructionNSVS(const std::string& name);

  /// Destructor
  virtual ~LLAVJacobFluxReconstructionNSVS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_LLAVJacobFluxReconstructionNSVS_hh
