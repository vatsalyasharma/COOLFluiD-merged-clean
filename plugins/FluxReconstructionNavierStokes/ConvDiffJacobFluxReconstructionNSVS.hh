...
#ifndef COOLFluiD_FluxReconstructionMethod_ConvDiffJacobFluxReconstructionNSVS_hh
#define COOLFluiD_FluxReconstructionMethod_ConvDiffJacobFluxReconstructionNSVS_hh
 ...
 */
class ConvDiffJacobFluxReconstructionNSVS : public ConvDiffJacobFluxReconstruction {

public: // functions

  /// Constructor
  explicit ConvDiffJacobFluxReconstructionNSVS(const std::string& name);

  /// Destructor
  virtual ~ConvDiffJacobFluxReconstructionNSVS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_ConvDiffJacobFluxReconstructionNSVS_hh
