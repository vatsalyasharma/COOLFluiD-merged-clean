...
#include "FluxReconstructionNavierStokes/ConvDiffLLAVFluxReconstructionNSVS.hh"
...
MethodCommandProvider< ConvDiffLLAVFluxReconstructionNSVS,
		       FluxReconstructionSolverData,
		       FluxReconstructionNavierStokesModule >
convDiffLLAVRHSNSVSFluxReconstructionProvider("ConvDiffLLAVRHSNSVS");

//////////////////////////////////////////////////////////////////////////////

ConvDiffLLAVFluxReconstructionNSVS::ConvDiffLLAVFluxReconstructionNSVS(const std::string& name) :
  ConvDiffLLAVFluxReconstructionVS(name),
  m_tempGradTerm(),
  m_tempGradTermL(),
  m_tempGradTermR(),
...
void ConvDiffLLAVFluxReconstructionNSVS::configure ( Config::ConfigArgs& args )
{
  ConvDiffLLAVFluxReconstructionVS::configure(args);
}

//////////////////////////////////////////////////////////////////////////////

void ConvDiffLLAVFluxReconstructionNSVS::computeWaveSpeedUpdates(vector< CFreal >& waveSpeedUpd)
{
  ...
  ConvDiffLLAVFluxReconstructionVS::computeWaveSpeedUpdates(waveSpeedUpd);
...
void ConvDiffLLAVFluxReconstructionNSVS::computeInterfaceFlxCorrection()
{
  for (CFuint iFlx = 0; iFlx < m_nbrFaceFlxPnts; ++iFlx)
  {
...
void ConvDiffLLAVFluxReconstructionNSVS::computeCellGradTerm(RealMatrix& gradTerm)
{
...
void ConvDiffLLAVFluxReconstructionNSVS::computeFaceGradTerms(RealMatrix& gradTermL, RealMatrix& gradTermR)
{
  for (CFuint iFlx = 0; iFlx < m_nbrFaceFlxPnts; ++iFlx)
  {
...
void ConvDiffLLAVFluxReconstructionNSVS::prepareFluxComputation()
{
...
void ConvDiffLLAVFluxReconstructionNSVS::computeGradients()
{
  ...
  // compute the gradients for the artificial viscosity (using conservative/solution variables)
    ...
    for (CFuint iSolPnt = 0; iSolPnt < m_nbrSolPnts; ++iSolPnt)
    {
      ...
      for (CFuint iEq = 0; iEq < m_nbrEqs; ++iEq)
      {
	    ...
	    m_projectedCorrL[jDir] = consState[iEq] * solPntNormals[solID*(m_dim+m_ndimplus)*m_dim+iDir*m_dim+jDir];
          }
...
void ConvDiffLLAVFluxReconstructionNSVS::computeGradientFaceCorrections()
{
...
void ConvDiffLLAVFluxReconstructionNSVS::computeSmoothness()
{
  CFreal sNum = 0.0;
...
void ConvDiffLLAVFluxReconstructionNSVS::computeSmoothness(const CFuint side)
{
  CFreal sNum = 0.0;
...
void ConvDiffLLAVFluxReconstructionNSVS::computeEpsilon0()
{
...
void ConvDiffLLAVFluxReconstructionNSVS::computeEpsilon0(const CFuint side)
{
  // compute a cell average characteristic flow speed. Note that a straight average is used, not a weighted one, maybe change this
  CFreal wavespeed = 0.0;
...
void ConvDiffLLAVFluxReconstructionNSVS::setup()
{
  CFAUTOTRACE;

  // setup parent class
  ConvDiffLLAVFluxReconstructionVS::setup();
