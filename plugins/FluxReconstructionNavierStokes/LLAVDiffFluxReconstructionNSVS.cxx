...
#include "FluxReconstructionNavierStokes/LLAVDiffFluxReconstructionNSVS.hh"
...
MethodCommandProvider< LLAVDiffFluxReconstructionNSVS,
		       FluxReconstructionSolverData,
		       FluxReconstructionModule >
LLAVDiffFluxReconstructionNSVSFluxReconstructionProvider("LLAVDiffNSVS");

//////////////////////////////////////////////////////////////////////////////

LLAVDiffFluxReconstructionNSVS::LLAVDiffFluxReconstructionNSVS(const std::string& name) :
  LLAVDiffFluxReconstructionVS(name),
  m_gradsBackUp(),
...
void LLAVDiffFluxReconstructionNSVS::configure ( Config::ConfigArgs& args )
{
  LLAVDiffFluxReconstructionVS::configure(args);
}

//////////////////////////////////////////////////////////////////////////////

void LLAVDiffFluxReconstructionNSVS::prepareFluxComputation()
{
...
void LLAVDiffFluxReconstructionNSVS::computeWaveSpeedUpdates(vector< CFreal >& waveSpeedUpd)
{
...
void LLAVDiffFluxReconstructionNSVS::setFaceData(CFuint faceID)
{
  LLAVDiffFluxReconstructionVS::setFaceData(faceID);
...
void LLAVDiffFluxReconstructionNSVS::setCellData()
{
  LLAVDiffFluxReconstructionVS::setCellData();
...
void LLAVDiffFluxReconstructionNSVS::computeInterfaceFlxCorrection()
{
  for (CFuint iFlx = 0; iFlx < m_nbrFaceFlxPnts; ++iFlx)
  {
...
CFreal LLAVDiffFluxReconstructionNSVS::computeViscCoef(RealVector* state)
{
  CFreal result = 1.0;
...
void LLAVDiffFluxReconstructionNSVS::computeSmoothness()
{
  CFreal sNum = 0.0;
...
CFreal LLAVDiffFluxReconstructionNSVS::computePeclet()
{
...
void LLAVDiffFluxReconstructionNSVS::computeFlxPntStatesAndGrads()
{
...
void LLAVDiffFluxReconstructionNSVS::computeDivDiscontFlx(vector< RealVector >& residuals)
{
...
void LLAVDiffFluxReconstructionNSVS::setup()
{
  CFAUTOTRACE;

  // setup parent class
  LLAVDiffFluxReconstructionVS::setup();
...
void LLAVDiffFluxReconstructionNSVS::unsetup()
{
  CFAUTOTRACE;
  ...
  LLAVDiffFluxReconstructionVS::unsetup();
}
