...
//Vatsalya: new class; NS-specific diffusive blending with BR2 damping, viscosity-based wave speed, and composition setting
...
#include "FluxReconstructionNavierStokes/DiffRHSFluxReconstructionNSBlendingVS.hh"
...
MethodCommandProvider< DiffRHSFluxReconstructionNSBlendingVS,
                       FluxReconstructionSolverData,
                       FluxReconstructionNavierStokesModule >
diffRHSNSBlendingVSFluxReconstructionProvider("DiffRHSNSBlendingVS");

//////////////////////////////////////////////////////////////////////////////

DiffRHSFluxReconstructionNSBlendingVS::DiffRHSFluxReconstructionNSBlendingVS(const std::string& name) :
  DiffRHSFluxReconstructionBlendingVS(name),
  m_tempGradTermL(),
  m_tempGradTermR(),
...
void DiffRHSFluxReconstructionNSBlendingVS::computeWaveSpeedUpdates(vector< CFreal >& waveSpeedUpd)
{
...
void DiffRHSFluxReconstructionNSBlendingVS::prepareFluxComputation()
{
...
void DiffRHSFluxReconstructionNSBlendingVS::computeInterfaceFlxCorrection()
{
  for (CFuint iFlx = 0; iFlx < m_nbrFaceFlxPnts; ++iFlx)
  {
...
void DiffRHSFluxReconstructionNSBlendingVS::setup()
{
  CFAUTOTRACE;

  // setup parent class (DiffRHSFluxReconstructionBlendingVS -> DiffRHSFluxReconstruction)
  DiffRHSFluxReconstructionBlendingVS::setup();

  // get damping coeff
  m_dampCoeff = getMethodData().getDiffDampCoefficient();

  // get the diffusive varset (NS-specific downcast)
