...
#ifndef COOLFluiD_FluxReconstructionMethod_NSGradientComputerVS_hh
#define COOLFluiD_FluxReconstructionMethod_NSGradientComputerVS_hh
 ...
 */
class NSGradientComputerVS : public ConvRHSFluxReconstruction {

public: // functions

  /// Constructor
  explicit NSGradientComputerVS(const std::string& name);

  /// Destructor
  virtual ~NSGradientComputerVS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_NSGradientComputerVS_hh
