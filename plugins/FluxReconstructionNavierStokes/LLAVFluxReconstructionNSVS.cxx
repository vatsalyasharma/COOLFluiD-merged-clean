...
#include "FluxReconstructionNavierStokes/LLAVFluxReconstructionNSVS.hh"
...
MethodCommandProvider< LLAVFluxReconstructionNSVS,
		       FluxReconstructionSolverData,
		       FluxReconstructionModule >
LLAVFluxReconstructionNSVSFluxReconstructionProvider("LLAVNSVS");

//////////////////////////////////////////////////////////////////////////////

LLAVFluxReconstructionNSVS::LLAVFluxReconstructionNSVS(const std::string& name) :
...
void LLAVFluxReconstructionNSVS::configure ( Config::ConfigArgs& args )
{
...
void LLAVFluxReconstructionNSVS::setFaceData(CFuint faceID)
{
...
void LLAVFluxReconstructionNSVS::setCellData()
{
...
void LLAVFluxReconstructionNSVS::computeInterfaceFlxCorrection()
{
...
CFreal LLAVFluxReconstructionNSVS::computeViscCoef(RealVector* state)
{
  CFreal result = 1.0;
...
void LLAVFluxReconstructionNSVS::computeSmoothness()
{
  CFreal sNum = 0.0;
...
CFreal LLAVFluxReconstructionNSVS::computePeclet()
{
...
void LLAVFluxReconstructionNSVS::setup()
{
  CFAUTOTRACE;
...
void LLAVFluxReconstructionNSVS::unsetup()
{
  CFAUTOTRACE;
