...
protected:
  ...
  /// Enable coupled positivity-preserving line search
  bool m_positivityLineSearch;

  /// Minimum values for positivity line search, one per equation.
  std::vector<CFreal> m_positivityMinValues;

  /// Enable filtered Newton update using the entropy-filter strength field.
  bool m_filterNewtonUpdate;

  /// Vatsalya: optional entropy-filter strength used to damp Newton updates.
  Framework::DataSocketSink<CFreal> socket_filterZeta;

  /// Cell builder for the filtered Newton update cell loop.
