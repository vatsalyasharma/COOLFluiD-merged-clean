#ifndef COOLFluiD_Numerics_FluxReconstructionMethod_CNEQSourceTermVS_hh
#define COOLFluiD_Numerics_FluxReconstructionMethod_CNEQSourceTermVS_hh
 ...
 *
 */
class CNEQSourceTermVS : public StdSourceTerm {
public:
   ...
   * Constructor.
   */
  explicit CNEQSourceTermVS(const std::string& name);
...
protected:
  ...
  /// Compute analytical source Jacobian via PLATO get_source_jac
  virtual void getSToStateJacobian(const CFuint iState); //Vatsalya:original had no override (base class returned zero matrix); AnalyticalJacob=true did nothing for CNEQ; implemented via PLATO get_source_jac with Rhoivt chain rule
...
#endif // COOLFluiD_Numerics_FluxReconstructionMethod_CNEQSourceTermVS_hh
