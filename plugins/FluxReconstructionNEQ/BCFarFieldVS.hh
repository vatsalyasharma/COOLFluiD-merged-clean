#ifndef COOLFluiD_FluxReconstructionNEQ_BCFarFieldVS_hh
#define COOLFluiD_FluxReconstructionNEQ_BCFarFieldVS_hh
...
class BCFarFieldVS : public BCStateComputer {
public: // functions
   ...
   * Constructor.
   */
  BCFarFieldVS(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~BCFarFieldVS();
...
#endif // COOLFluiD_FluxReconstructionNEQ_BCFarFieldVS_hh
