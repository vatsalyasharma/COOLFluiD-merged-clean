...
#include "FluxReconstructionNEQ/BCFarFieldVS.hh"
...
Framework::MethodStrategyProvider<
    BCFarFieldVS,FluxReconstructionSolverData,BCStateComputer,FluxReconstructionNEQModule >
  BCFarFieldVSProvider("BCFarFieldVS");

// MethodCommandProvider<BCFarFieldVS,
//                       FluxReconstructionSolverData,
//                       FluxReconstructionNEQModule>
// aBCFarFieldVSProvider("BCFarFieldVS");

//////////////////////////////////////////////////////////////////////////////

void BCFarFieldVS::defineConfigOptions(Config::OptionList& options)
{
...
//////////////////////////////////////////////////////////////////////////////
BCFarFieldVS::BCFarFieldVS(const std::string& name) :
...
BCFarFieldVS::~BCFarFieldVS()
{
}

//////////////////////////////////////////////////////////////////////////////

void BCFarFieldVS::computeGhostStates(const vector< State* >& intStates,
                                         ...
                                         const std::vector< RealVector >& coords)
{
  ...
  for (CFuint iState = 0; iState < nbrStates; ++iState)
  {
    ...
    const CFuint nbEqs = intState.size();
...
void BCFarFieldVS::computeGhostGradients(const std::vector< std::vector< RealVector* > >& intGrads,
                                            ...
                                            const std::vector< RealVector >& coords)
{
  ...
  // set the ghost gradients (generic: works for any number of equations)
  // enforce zero normal gradient through interior/ghost pairing
...
//void BCFarFieldVS::executeOnTrs()
//{
      //CFAUTOTRACE;
...
/*
//////////////////////////////////////////////////////////////////////////////
void BCFarFieldVS::setGhostState(Framework::GeometricEntity *const face){
