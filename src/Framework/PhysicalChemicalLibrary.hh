...
public:
  ...
  //Vatsalya: new-added virtual getSpeciesEntropy() with NotImplemented default; PLATO override in PlatoLibrary provides actual implementation for EntropyFilteringVS
  ...
  virtual void getSpeciesEntropy(CFdouble& temp, CFdouble& pressure, RealVector& si)
  {
    throw Common::NotImplementedException
      (FromHere(),"PhysicalChemicalLibrary::getSpeciesEntropy()");
  }
